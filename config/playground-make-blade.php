...
return [
    ...
    */
    ...
    'about' => (bool) env('PLAYGROUND_MAKE_BLADE_ABOUT', true),
    ...
    */
    ...
    'load' => [
        'commands' => (bool) env('PLAYGROUND_MAKE_BLADE_LOAD_COMMANDS', true),
        'translations' => (bool) env('PLAYGROUND_MAKE_BLADE_LOAD_TRANSLATIONS', true),
    ],
];
