...
/**
 * \Playground\Make\Blade\Building\BuildDetail
 */
trait BuildDetail
{
    /**
     ...
     */
    protected array $detail_flags_danger = [
        'unknown',
        'problem',
    ];
     ...
     * @var array<int, string>
     */
    protected array $detail_flags_info = [
        'pending',
    ];
     ...
     * @var array<int, string>
     */
    protected array $detail_flags_success = [
        'active',
    ];
     ...
     * @var array<int, string>
     */
    protected array $detail_flags_warning = [
        'locked',
    ];

    protected function build_detail_flags(Model $model): void
    {
